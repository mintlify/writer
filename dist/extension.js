...
exports.addComments = exports.getFileExtension = exports.getInsertPosition = exports.getHighlightedText = void 0;
...
const wrapAround = (code, start, end, newLine) => {
    if (newLine) {
        return `${start}\n${code}\n${end}`;
    }
    return `${start} ${code} ${end}`;
};
const singleLine = (code, comment) => {
...
const addComments = (code, filename) => {
